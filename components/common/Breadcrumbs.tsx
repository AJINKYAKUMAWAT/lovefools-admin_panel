...
import ComponentProps from '@/types/component/common/breadcrumb';

const Breadcrumbs: React.FC<ComponentProps> = ({ items, onAction }) => {
  ...
  const handleItemClick = (clickedIndex: number, parentId: number) => {
    if (parentId) {
